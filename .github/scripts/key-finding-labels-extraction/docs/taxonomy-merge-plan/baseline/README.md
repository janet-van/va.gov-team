...
```bash
node .github/scripts/key-finding-labels-extraction/cli/check-contract.js
node .github/scripts/key-finding-labels-extraction/cli/capture-snapshot.js
node .github/scripts/key-finding-labels-extraction/cli/compare-snapshots.js \
...
```bash
node .github/scripts/key-finding-labels-extraction/cli/generate-recalibration-dataset.js \
...
node .github/scripts/key-finding-labels-extraction/cli/check-recalibration-trends.js \
...
```bash
node .github/scripts/key-finding-labels-extraction/cli/tune-recalibration-thresholds.js \
...
```bash
node .github/scripts/key-finding-labels-extraction/cli/run-recalibration-stability-cycle.js \
  --runs=3 \
  --strict=true \
