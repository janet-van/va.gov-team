...
### Code
 - [geographicMeansThreshold.js](https://github.com/department-of-veterans-affairs/vets-website/blob/main/src/applications/financial-status-report/actions/geographicMeansThreshold.js) (FSR file for fetching GMT data)
  ...
  - If you want to do some testing locally and update the gmt database and you're running docker you can [find those docs here](https://github.com/department-of-veterans-affairs/va.gov-team/blob/master/teams/benefits-portfolio/benefits-memorials-2/engineering/front-end/getting-started/howto-local-gmt-db-update.md)!
### Links
