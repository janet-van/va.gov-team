---
title: Chatbot Controlled Study Research Report Research Findings
product: Search
...
- Not specified
research_goals:
- the ultimate goal to understand if participants would use the chatbot again
- "Understand how well the chatbot performed (answered questions accurately, understood what participants were trying to ask, and if participants had information needed to take the next step to complete\
  \ a task"
