---
title: "1095-B Tax Document Research Findings – Round 1 Research Findings"
product: Search
...
demographics:
  ...
  disability:
    ...
    captions: 0
key_findings:
- "5/6 participants recalled getting the 1095-B form"
- 4/6 participants preferred digital delivery
- "Version shown was to test concept, not execution."
- 5/6 participants were negative towards calling a customer service phone number.
- Digital is seen as an opportunity to avoid the hassle
- "2/6 participants said they wouldn&#39;t bother calling the customer service number"
- "4/6 Participants were unclear if they actually needed the 1095-B to submit with their taxes."
- 4/6 Participants went to the Records panel first
recommendations:
...
- "For next round of user testing with high fidelity designs, further explore preferences around updating the form (if information is incorrect) and how the participants understand the requirements of keeping\
  \ the 1095-B document and including it their taxes."
kpi_alignment: []
outcomes:
  user: Not specified
