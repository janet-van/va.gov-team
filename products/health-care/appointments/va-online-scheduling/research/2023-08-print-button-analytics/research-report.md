...
demographics:
  ...
  disability:
    ...
    captions: 0
key_findings:
- "Immediately on release, users started clicking the print button."
- August was the first month since November 2022 where no users left comments related to printing.
recommendations: []
kpi_alignment: []
outcomes:
  user: Not specified
