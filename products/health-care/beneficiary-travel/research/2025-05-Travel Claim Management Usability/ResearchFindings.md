...
- Not specified
research_goals:
- "providing them information about the outcome of their claim decision on VA.gov, 2) providing Veterans with an unofficial digital copy of their claim decision letter on VA.gov and 3) easily connecting\
  \ them to the supported digital appeals process from denied claims.  The designs tested in this study provide these connections on a Claim Details page related to an individual claim.  This study tests\
  \ key facets of user flow for appealing a denied travel claim on VA.gov"
methodology:
- "usability-testing"
...
- Research Questions
recommendations:
- "Participants accurately identified the appropriate next steps and how to initiate an appeal for a denied claim, but some struggled with the best way to move forward"
- "On the Claim Details page, participants placed greater value on information directly related to what they should expect next"
