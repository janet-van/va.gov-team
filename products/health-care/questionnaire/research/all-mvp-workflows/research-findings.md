---
title: All “Primary care questionnaire” MVP Workflows Discovery Readout Research Findings
product: Health Questionnaire
team: Health Questionnaire Team
office: "Office of the CTO - Digital Experience (OCTO-DE)"
date: Not specified
researchers:
- "Kristen McConnell <br>"
research_goals:
- "and post-appointment experiences for Veterans, contribute to physical distancing efforts in VA facilities, and better integrate Veteran-provided data in VA workflows by providing Veterans with a digital\
  \ option to complete pre- or post-appointment questionnaires and screeners."
methodology:
- "usability-testing"
- survey
- discovery
...
- "Questionnaire links within text messages are more easily overlooked by participants who already receive appointment reminder text messages, because participants automatically reply confirm/cancel and\
  \ don’t read the rest of the text."
