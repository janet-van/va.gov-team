...
- "Proposed problem statement: There is not currently an avenue for Veterans to consistently share and update current health status and medical history that is leveraged in their care across the VA and\
  \ community providers"
