---
title: 0781 Evidence Upload Topline Summary Research Findings
...
# **0781 Evidence Upload Topline Summary**
...
* Prototype in Figma: [Mobile](https://www.figma.com/proto/9idAmDRkCyDwJ7hTemJgAV/0781---Evidence-Upload?node-id=5-95588&p=f&t=y3emzFmk5pR18ElW-0&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1) (options to toggle between Path 1 and Path 2\)  
...
* Interview transcripts: [VA Disability Benefits SharePoint Folder](https://www.figma.com/proto/9idAmDRkCyDwJ7hTemJgAV/0781---Evidence-Upload?node-id=5-95588&p=f&t=y3emzFmk5pR18ElW-0&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1)

This topline summary is a high level, top of mind summary of trends found in the sessions, but is not the final result of working with the data discovered. The information in this document may change following a deeper review and analysis of the data gathered. The goal of this document is:
...
* “This is not what I was expecting for the next page, because once you've uploaded \[documents\]…you really don't want to see that again. It's like, alright, did it not work, so should I load everything else up?” –P5

## **Hypotheses (pre-synthesis conclusions)**

* Most participants will understand there are three steps: Likely not true  
* Find specific guidance for mental health helpful: Likely maybe true  
* Find summary screens helpful: Likely true  
* Understand the document descriptions, and find the external links supportive: Likely maybe true
