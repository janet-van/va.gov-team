...
title: "Research Plan for Employee Experience Team, Maximum CFI Explorations, October 2023"
date: 2023-10-02
last_updated: 2023-10-17
team: "Employee Experience Team"
product: "Maximum CFI (Claims for Increase) Explorations"
product_area: "authenticated"

# Background Context
background:
  problem_statement: "VA receives many claims for increase for conditions already at maximum rating, wasting time for both Veterans and claims processors. Need to reduce these unnecessary CFI submissions through design interventions."
  product_location: "VA.gov - View Rated Disabilities page and 526 Select Rated Disabilities page"
  user_familiarity: "Iteration - testing design interventions on existing pages"
...
research_goals:
  - goal_1: "Evaluate relative effectiveness of 3 interventions in reducing maxed-out tinnitus claims"
  - goal_2: "Determine if displaying maximum ratings for other conditions is worth the effort"
  - goal_3: "Get feedback on each design to determine refinement needs"

research_questions:
  - "Which method is most likely to dissuade Veterans from submitting a CFI?"
  - "Do Veterans have a preference between the methods reviewed?"
  - "Do Veterans understand the educational content in Scenario 1?"
  - "What do Veterans think about separated list of max-rated conditions in Scenario 2?"
  - "Would Veteran still submit claim with added friction in Scenario 3?"
  - "How likely would Veteran submit CFI after seeing all maximum ratings listed?"
  - "How does each concept communicate choices?"
  - "Do any concepts help Veterans feel more confident or that VA is on their side?"
  - "Does the information seem trustworthy?"
  - "Is there additional information Veterans need when deciding?"

hypotheses:
  - "Design modifications will reduce confirmed-and-continued claims at maximum rating for Tinnitus"
  - "Educational content outside claims flow can reduce maximum CFI claims"
  - "Adding friction to application for max-rated conditions will dissuade Veterans and reduce confusion"
  - "Some Veterans may be suspicious of VA advising not to request increase"
  - "Veterans may find VA math around maximum ratings opaque and untrustworthy"

expected_outcomes: "Decide whether to proceed with any of the three interventions, inform subsequent design if research shows potential effect"

# Recruitment & Participants
recruitment:
  recruiting_partner: "Perigean"
  approach: "Lean maximum variation strategy targeting inclusivity"
  
  primary_criteria:
    - "All participants have used VA.gov to file a claim (disability, pension, or other)"
    - "At least 4 but no more than 10 Veterans identify as gender other than male"
    - "At least 4 but no more than 8 Veterans over 55 years old"
    - "At least 3 but no more than 8 identify as having cognitive disability"
    - "At least 6 recently filed claim for increase (within last 3 months)"
    - "At least 2 rated for Tinnitus and 2 for Migraines (total 4 rated for either)"
  ...
  screener_questions:
    ...
    - question: "Have you ever filed a claim for increase on a disability?"
      qualifying_response: "Yes - recruit those who filed July-September 2023"
    - question: "Are you currently receiving disability compensation for any of these conditions?"
      qualifying_response: "Migraine headaches (recruit 2+), Tinnitus (recruit 2+)"
...
related_research:
  previous_studies: 
    - "https://github.com/department-of-veterans-affairs/va.gov-team/tree/master/products/disability/abd-vro"
    
tags:
  - "BNFT: Disability"
  - "AUD: Veterans"
  - "PRDT: Claims-for-increase"
  - "PRDT: Form-526"
  ...
  - "PACT-Act"
study: "Employee Experience Team, Maximum CFI Explorations"
