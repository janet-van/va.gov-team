...
- "Increase the time needed for Multi-Factor-Authentication. Limited vision and screen reader users take extra time to use their devices to get a code. This is most prominent if the user does not use an\
  \ Apple product with push notifications"
