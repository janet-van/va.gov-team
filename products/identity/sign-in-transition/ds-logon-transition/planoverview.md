...
title: "Research Plan for identity, identity, 2026-03-23"
date: 2026-03-23
...
# Background Context
background:
  problem_statement: "Planning overview for DS Logon transition"
  product_location: "VA.gov Sign-in Transition"
  user_familiarity: "TBD - New product or iteration?"
  product_brief_url: "TBD - Add product brief URL if available"

# Research Design
methodology: "Transition planning"
research_format: 
  location: remote
  moderated: true
