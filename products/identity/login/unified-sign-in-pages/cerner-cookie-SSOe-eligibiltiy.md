# CERNER_ELIGIBLE cookie behavior (Frontend)
...
### Cookie is missing, malformed, or empty
   ```
...
- “Should this user use OAuth?”
not
- “Is this user Cerner eligible?”
