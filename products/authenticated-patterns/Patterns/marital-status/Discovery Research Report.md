---
title: Discovery Research Report Research Findings
product: Search
...
- Teams should only include questions required by their form. This helps ensure that we reduce the trauma that can come with discussing past marriages and even deceased spouses. We’ll note this in our pattern
  documentation for teams.
- "Some of the above pages display differently depending on a user’s former answers. For example, if the user indicates that their former spouse is deceased, we will use past tense when discussing them\
  \ on subsequent pages.We will also hide some of the questions such as requests for contact information."
