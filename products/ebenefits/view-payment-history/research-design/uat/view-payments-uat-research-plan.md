...
title: "User Acceptability Testing (UAT) for View Payment History"
date: 2020-12-01
...
# Background Context
background:
  problem_statement: "Veterans need to review their VA compensation & pension and education payments. The View Payment History tool displays payments in tables similar to consumer banking apps. Need to test in production to confirm complete and accurate presentation of users' payment data."
  product_location: "VA.gov (production environment)"
  user_familiarity: "Migration from eBenefits to VA.gov"
...
research_goals:
  - goal_1: "Confirm the complete and accurate presentation of users' VA C&P payments, education payments, and returned payments"
  - goal_2: "Validate that users can quickly and easily review their payment history"
  - goal_3: "Ensure users can find a particular payment within a date range using pagination"

research_questions:
  - "Can users quickly and easily review their history of VA payments/returned payments?"
  - "Can users easily find a particular payment/returned payment within a date range using the pagination feature?"
  - "Is the payment information complete and accurate?"

# Methodology Details
research_type: "Evaluative"
session_format: "Remote moderated UAT sessions"
timeline: "2021-01-05 to 2021-01-15"

# Participants
participant_count: 4
recruitment_criteria: "Veterans who receive C&P or EDU payments, are LOA3 identity verified, and have ID.me credentials"
...
# Tags
tags: ['research', 'UAT', 'ebenefits', 'payment-history', 'C&P', 'education-payments', 'authenticated', 'production', 'research-plan']
---


# Research plan for user acceptability testing (UAT) for View Payment History / production environment
