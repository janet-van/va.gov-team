...
title: "Veterans Service Organization (VSO) Representative Discovery Interviews"
date: 2021-07-01
last_updated: 2026-03-23
team: "eBenefits"
product: "Power of Attorney (Forms 21-22/22a)"
product_area: "authenticated"

# Background Context
background:
  problem_statement: "Veterans and service members can appoint VSOs, attorneys, or claims agents to help with benefits claims using Form 21-22/a. Research on Veteran experiences is complete. Now need to understand the VSO perspective on the representation process, pain points, and how they interact with Veterans to inform tool design."
...
research_goals:
  - goal_1: "Understand how the representation/Power of Attorney process works for VSOs"
  - goal_2: "Learn how representatives interact with service members"
  - goal_3: "Identify pain points to inform tool design that increases Veterans' success in selecting representatives"

research_questions:
  - "How does an organization or individual become a VSO?"
  - "How does a Veteran or Service Member find a VSO?"
  - "Do Veterans contact representatives for consultation before making a selection?"
  - "Do representatives accept all appointments, or are there limits?"
  - "Do Veterans use VA Form 21-22/a? If so, do they typically submit online or on paper?"
  - "How do representatives interact with Veterans (phone, email, in person)?"

# Methodology Details
research_type: "Generative"
session_format: "Remote moderated audio-only discovery interviews via Zoom"
timeline: "2021-08-11 to 2021-08-20"

# Participants
participant_count: 5
recruitment_criteria: "Accredited representatives with Veterans Service Organizations through VA contacts (Paul Shute, Bill Meadows)"

# Team
moderator: "James Adams"
notetaker: "eBenefits team"
observers: "Candy Clark, Jason Wolf, Kathleen Crawford, Kevin Musiorski, Micah Chiang, Jesse Cohn, Matt Self, Sabrina Mohamed"

# Tags
tags: ['research', 'discovery', 'ebenefits', 'power-of-attorney', 'POA', 'VSO', 'representatives', 'stakeholder-interviews', 'form-21-22', 'form-21-22a', 'research-plan']
---
