---
title: Create GitHub Issues from Research Findings Prompt Research Findings
product: Search
...
- approves)
- approval before including them
research_goals:
...
- Create each issue as a draft in the workbench
recommendations:
...
- "If you use GPT, Gemini, or Grok models, you'll need to manually copy and paste the generated issue content into GitHub's issue creation form (see the [Fallback Method](#fallback-method-for-non-claude-models)\
  \ section below)."
kpi_alignment: []
outcomes:
  user: Not specified
