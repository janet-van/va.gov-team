...
- Team Name: Core Veterans Experience
- GitHub Label: va-cve
- Slack channel: #cve-product-teams-public
- Product POCs: Janet Van (Product Manager) and Dave Conlon (VA PO)
- Stakeholders:   
    - OCTO (Dave Conlon)
...
<details>
 ...
 - PM: Janet Van, janet.van@wilcore.io
 - Engineering: Kyle Henson, 
