...
- Not specified
research_goals:
- "Understand how Veterans and their families would want to leverage a chat experience, how it works for them today [in the VA and outside of the VA], and in what instances they would not want to use a\
  \ chat experience"
- "Map out what a Veteran’s experience journey would look like if they were to leverage a live chat experience; considering the different archetypes and variance in the problems to be solved, what does\
  \ the happy path look like?"
methodology:
...
- "Enabling this is a matter of creating a platform that provides strong connections to consumers of the data, and allows Contact Centers to independently, and through self-service, create more enriching\
  \ Chat experiences."
