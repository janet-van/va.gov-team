...
- Nick Osmanski
research_goals:
- Participants will perform a hybrid card sort for a list of new and currently existing services to determine how Veterans categorize health and administrative services
- Veterans will associate most services with existing category headings
- Veterans will expect the same naming conventions defined by health service taxonomy
- Veterans will expect a defined service list defined by taxonomy
methodology:
...
- Some services were much more likely to be grouped together
recommendations:
