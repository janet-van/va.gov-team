...
recommendations:
- "Include as much contextual detail (eg. copay, overpayment, amount, date, decision, address, direct POC, doctor, department, type of appointment, phone number & ext. etc. )as possible. This will inform\
  \ and help set expectations of what a Veteran will see when they log in to review information or take an action (without stepping on PII or HIPAA)."
...
- "Our research only included a few samples from different business lines but going forward, all communications should hew to exciting research recommendations and or guidelines and any new styles or substantively\
  \ different content should be evaluated by Veterans."
kpi_alignment: []
outcomes:
  user: Not specified
