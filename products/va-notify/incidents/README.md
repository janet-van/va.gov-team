...
| October 2024 | [API degradation due to client notification spike](./20241022-api-degradation-client-notification-spike.md) — P50 latency 10x normal for ~4 hours over 2 days | High | Resolved |
