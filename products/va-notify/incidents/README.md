...
| July 2022 | [VEText inbound routing failure due to token overwrite](./20220713-vetext-inbound-routing-token-overwrite.md) — Terraform overwrote SSM token, blocking inbound message routing to VEText | TBD | Resolved |
